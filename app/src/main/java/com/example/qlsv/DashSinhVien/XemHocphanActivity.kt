...
import HocPhan_.AddHHocphanActivity
...
class XemHocphanActivity : AppCompatActivity() {

    private val xemdshp: Button by lazy { findViewById(R.id.xemhpdk_hp) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_xem_hocphan)
    ...
    private fun setupListeners() {
        xemdshp.setOnClickListener {
            val intent = Intent(this, DanhsachDangkiActivity::class.java)
            intent.putExtra("MSSV", mssv)
            startActivity(intent)
        }

        thoat.setOnClickListener {
            startActivity(Intent(this, MainSinhvienActivity::class.java))
        }
        ...
        lview.onItemClickListener = AdapterView.OnItemClickListener { _, _, position, _ ->
            ...
            val intent = Intent(this, XemLopHocphanActivity::class.java).apply {
    ...
    override fun onContextItemSelected(item: MenuItem): Boolean {
        ...
        return when (item.itemId) {
            ...
            1 -> {
                startActivity(Intent(this, XemHocphanActivity::class.java))
                true
            }
